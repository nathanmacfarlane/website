...
export const NavBar = () => {
    ...
    return (
        ...
        >
            <NavItem style={{ cursor: "pointer" }} num={4} text="Contact" onClick={() => scrollTo(5)} />
            <NavItem style={{ cursor: "pointer" }} num={3} text="Projects" onClick={() => scrollTo(4)} />
            <NavItem style={{ cursor: "pointer" }} num={2} text="Experience" onClick={() => scrollTo(3)} />
            <NavItem style={{ cursor: "pointer" }} num={1} text="Me" onClick={() => scrollTo(2)} />
        </div>
    )
}